drop database if exists tt_shop;
create database tt_shop default character set utf8 collate utf8_general_ci;
grant all on tt_shop.* to 'taguchi_tomoaki'@'localhost' identified by 'Asdf3333-';
use tt_shop;
